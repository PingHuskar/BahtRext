...
var PrintBaht = function (money) {
    ...
    while (money != "") {
        ...
        newMoney.push("".concat(hundredThousandToOne(selectedupto6digit)).concat(f6 ? "" : MILLION));
        f6 ? f6 = !f6 : "";
...
var SatangSecondDigit = function (digit) {
    if (digit[1] === undefined || digit[1] === "0")
        return "";
    if (digit[0] !== "0" && digit[1] === "1")
        return SPECIALONE;
    return "".concat(THAINUMBERWORDS[parseInt(digit[1])]);
};
var PrintSatangs = function (satangs) {
    if (satangs === "")
        return "ถ้วน";
    var satangword = "".concat(SatangFirstDigit(satangs[0])).concat(SatangSecondDigit(satangs), "\u0E2A\u0E15\u0E32\u0E07\u0E04\u0E4C");
    return satangword;
};
...
var BahtText = function (money) {
    ...
    return "".concat(numberWithSeperator(moneyFull, ","), " \u0E2D\u0E48\u0E32\u0E19\u0E27\u0E48\u0E32 \"").concat(PrintBaht(moneyInt)).concat(BAHT).concat(PrintSatangs(moneyFrac), "\"");
};
var testcases = [
